...
function page() {
    ...
    try {
            const parameter = await fetch(`http://127.0.0.1:8000/api/rol`);
    ...
    return (
        <div className="flex flex-col w-full items-center">
            ...
            <h1 className=" text-3xl pt-3">Rol Table</h1>
            <section className="container px-4 mx-auto flex flex-col items-center">
                <div className="flex flex-col mt-10 w-3/6 items-center justify-center">
